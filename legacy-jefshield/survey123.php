...
<head>
  ...
  <!-- Main style sheet -->
  <link rel="stylesheet" type="text/css" href="https://jeftechno.com/css/style.css">
...
<body>
  ...
  <div class="main-page-wrapper">
    <div class="container" style="margin-top:40px;">
      ...
      <a href="https://jeftechno.com/elecrama.php" class="tran3s p-color-bg hvr-shutter-out-horizontal-two">go home</a>
    </div> <!-- /.error-page -->
  </div> <!-- /.container -->
  <!-- j Query -->
  <script type="text/javascript" src="https://jeftechno.com/vendor/jquery-2.1.4.js"></script>

  <!-- Bootstrap JS -->
  <script type="text/javascript" src="https://jeftechno.com/vendor/bootstrap/bootstrap.min.js"></script>

  <!-- Vendor js _________ -->
  <!-- Camera Slider -->
  <script type='text/javascript' src='https://jeftechno.com/vendor/Camera-master/scripts/jquery.mobile.customized.min.js'></script>
  <script type='text/javascript' src='https://jeftechno.com/vendor/Camera-master/scripts/jquery.easing.1.3.js'></script>
  <script type='text/javascript' src='https://jeftechno.com/vendor/Camera-master/scripts/camera.min.js'></script>

  <!-- WOW js -->
  <script type="text/javascript" src="https://jeftechno.com/vendor/WOW-master/dist/wow.min.js"></script>
  <!-- owl.carousel -->
  <script type="text/javascript" src="https://jeftechno.com/vendor/owl-carousel/owl.carousel.min.js"></script>
