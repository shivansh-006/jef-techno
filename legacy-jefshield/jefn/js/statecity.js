var citiesByState = {
    ...
    Jharkhand: ["Daltonganj","Hazaribagmh","Ranchi","Chaibasa","Dumka"],
...
function makeSubmenu(value) {
    console.log(value)
    if(value.length==0){
        document.getElementById("selectCity").innerHTML = "<option value=''>Select City</option>";
    }
    else {
        let citiesOptionsData = "";
        for(cityId in citiesByState[value]) {
            citiesOptionsData += "<option>"+citiesByState[value][cityId]+"</option>";
        }
        document.getElementById("selectCity").innerHTML = citiesOptionsData;
    }
}
