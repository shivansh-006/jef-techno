...
async function DwgFileUploads(e) {
    ...
    if (null !== a) {
        ...
        if (!/(\.dwg|\.zip|\.rar)$/i.exec(l))
            return alert("INVLIAD FILE FORMAT...! Only dwg files are Allowed"), n = {
                fileSrc: "",
                filename: ""
            },
        a.value = "",
...
async function ShowAlertMessage() {
    alert("Kindly Upload the Terrace plan with Equipment(if any), Elevation & Sectional Drawings, Ground floor plan and Basement floor plans in AutoCAD format in a single ZIP file or all drawings in a Single DWG File")
}
        ...
        success: function (e) {
            ...
            case 1:
                ...
                $.each(e.bldglist, (function (e, l) {
                        if (a += '<tr>                             <td>                                 <div class="widget-content p-0">                                     <div class="widget-content-wrapper">                                         <div class="widget-content-left mr-3">                                             <div class="widget-content-left">                                                 <img width="40" class="rounded-circle" src="assets/images/avatars/2.jpg" alt="">                                             </div>                                         </div>                                         <div class="widget-content-left flex2">                                             <div class="widget-heading">                                                 <a href="project-detail.php#' + l.bldgid + '">' + l.projectname + '</a>                                             </div>                                             <div class="widget-subheading opacity-7"></div>                                         </div>                                     </div>                                 </div>                             </td>                             <td class="text-center">' + l.city + '</td>                             <td class="text-center">', null == l.filepath || null == l.filepath || "" == l.filepath ? (a += '<a > <img src="assets/images/q2.png" alt="Download">\t</a>', $("#refcheck").val(64646)) : a += '<a href="' + l.filepath + '" download> <img src="assets/images/q2.png" alt="Download">\t</a>', a += '</td>                             <td class="text-center">                                 <center>                                     <div class="col-md-8">                                         <input type="file" class="form-control" onclick="ShowAlertMessage()"  onchange="DwgFileUploads(' + l.bldgid + ')" name="Dwg_file' + l.bldgid + '" id="Dwg_file' + l.bldgid + '">                                     </div>                                 </center>                             </td>', a += '<td class="text-center">', (null === l.jefrev || void 0 === l.jefrev ? 0 : l.jefrev) > 0) {
                            let e = (l.latest_file || "").split("||").pop();
                            a += '<a href="' + e + '" download class="badge badge-secondary">Download</a>'
                        } else
