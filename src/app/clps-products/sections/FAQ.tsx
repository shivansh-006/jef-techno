...
const FAQ = () => {
  ...
  return (
    <section className="w-full bg-[#232427] py-16 md:pt-[86px] md:pb-[120px] overflow-hidden">
      <div className="max-w-[1508px] mx-auto flex flex-col gap-[32px] md:gap-[48px] px-6 md:px-[100px]">
        <motion.h2 
          initial={{ opacity: 0, x: -20 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="font-montserrat font-bold text-[32px] md:text-[40px] leading-[1.2] md:leading-[55px] uppercase text-[#C02429]"
        >
          FAQ
        </motion.h2>
