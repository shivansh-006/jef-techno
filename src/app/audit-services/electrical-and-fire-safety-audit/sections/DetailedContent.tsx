...
const pages = [
  {
    ...
    content: (
      <>
        ...
        <h3 className="text-brand text-[16px] md:text-[18px] lg:text-[20px] uppercase font-bold tracking-[1px] md:tracking-[1.49px] mt-8 leading-[1.4]">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h4 className="text-brand text-[16px] md:text-[18px] lg:text-[20px] uppercase font-bold tracking-[1px] md:tracking-[1.49px] mt-8 leading-[1.4]">
          What JEF Covers:
        </h4>
  ...
  },
  {
    ...
    content: (
      ...
      <p className="text-[16px] md:text-[18px] lg:text-[20px] font-normal leading-[1.5] text-white text-justify">
        ...
        <h3 className="text-brand text-[16px] md:text-[18px] lg:text-[20px] uppercase font-bold tracking-[1px] md:tracking-[1.49px] mt-10 leading-[1.4]">
        ...
        <div className="flex items-center justify-between gap-4 mb-9">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              ...
              aria-label="Next tab"
              className="rounded-full h-12 w-12 border border-brand text-brand text-[18px] md:text-[14px] tracking-[1px] uppercase hover:text-white hover:border-white transition-colors duration-300 cursor-pointer"
            >
              →
            </button>
          </div>
