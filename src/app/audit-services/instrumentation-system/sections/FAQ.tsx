...
const faqData = [
  {
    id: 1,
    question:
      "Why do well-maintained plants still experience unexplained instrumentation trips?",
    answer:
  ...
  },
  {
    id: 2,
    question:
      "What are the most common causes of instrumentation system failure?",
    answer:
      "JEF’s audits across thousands of assets identify 12 key factors, including leakage and circulating currents, incorrect earthing or cabling philosophies, compromised common earthing points (CEP), high shield currents, and power quality disturbances.",
  },
  {
    id: 3,
    question:
