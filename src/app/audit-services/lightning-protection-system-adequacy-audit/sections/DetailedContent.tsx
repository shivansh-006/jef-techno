    ...
    content: (
      <>
        ...
        <button 
          ...
          className="w-fit rounded-full bg-black border-2 border-brand px-6 py-2 text-brand text-[14px] font-bold uppercase hover:underline cursor-pointer relative z-30 mt-4"
        >
          JEF Shield
        </button>
      </>
