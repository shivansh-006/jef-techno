...
const Hero = ({
  title = "LIGHTNING PROTECTION SYSTEM ADEQUACY AUDIT",
  videoSrc,
}) => {
  return (
        ...
        <div className="section-container w-full px-5 md:px-0">
          ...
          >
            ...
            <p className="max-w-[1500px] text-[13px] sm:text-[15px] md:text-[17px] lg:text-[22px] leading-[1.7] text-white/90">
              Lightning Protection Adequacy Audit is needed to check the adequacy
              and healthiness of the existing LPS and its conformity to the
              latest standards in such a manner that prevents injury to personnel
              and property damage.
            </p>
          </motion.div>
        </div>
